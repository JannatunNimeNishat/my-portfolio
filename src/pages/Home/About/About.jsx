        ...
        <div className="bg-black text-white pt-20 " id='about'>
            <div className="px-28 py-28 grid grid-cols-6 gap-5">
                ...
                <div className='col-span-4 ml-20 w-full '>
                    ...
                    <p className='mt-5'>I am a motivated and aspiring junior Frontend Developer with a strong foundation in frontend technologies. With a keen eye
                    ...
                    <p className='mt-5'> A few  technologies I’ve been working with recently:</p>
                    ...
                    <div className='mt-8' onClick={() => {window.open("https://drive.google.com/file/d/1m4-imPm8TCPHA2D8_Xn8LotlZeYCXgug/view", "_blank");}}>
